      ...
      <div className="w-full md:w-4/5 mx-auto relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-start">
          ...
          <div className="flex flex-col justify-start">
            <h2 className="text-7xl sm:text-6xl md:text-9xl lg:text-9xl font-bold text-left text-white mb-6 sm:mb-8 md:mb-12 drop-shadow-lg font-heading tracking-tight hover:text-blue-500 transition-all duration-300">
              About <br/>Me
            </h2>
            <p className="w-full text-justify drop-shadow-md font-normal text-base sm:text-lg md:text-xl text-white leading-relaxed font-inter mb-8">
            ...
            <div className="flex flex-col sm:flex-row md:flex-row gap-4 w-full">
              <a href="#works" className="w-1/2 md:w-1/3 flex gap-2 items-center px-8 py-4 border-2 border-gray-600 text-black font-semibold rounded-full bg-white hover:bg-transparent hover:text-white transform hover:scale-105 hover:shadow-xl transition-all duration-300">
                <Briefcase size={18} className="sm:w-5 sm:h-5" />  
                <span>Projects</span>
              </a>
              <a href="https://github.com/leartbllacaku" target="_blank" className="w-1/2 md:w-1/3 flex gap-2 items-center px-8 py-4 border-2 border-gray-600 text-gray-300 font-semibold rounded-full hover:bg-white hover:text-black transform hover:scale-105 hover:shadow-xl transition-all duration-300">
          ...
          {/* Right Side: Hanging Technologies (top) and Scrolling Technologies (bottom) */}
          <div className="flex flex-col items-center w-full max-w-lg mx-auto">
            ...
            <div ref={technologiesRef} className="relative w-full h-80 sm:h-96 md:h-[28rem] lg:h-[32rem] -mt-8 lg:-mt-16">
              {hangingTechnologies.map((tech, index) => {
                const stringLengths = [80, 120, 160, 100, 140];
                const positions = [10, 25, 45, 70, 85];
            ...
            <div className="w-full mt-24 lg:mt-16">
              ...
              <div className="relative overflow-hidden max-w-md mx-auto">
                <div
                  className={`flex flex-nowrap gap-4 sm:gap-6 md:gap-8 py-4 transition-transform duration-1000 ${marqueeInView ? 'animate-marquee' : ''}`}
                  ref={marqueeRef}
